   ...
   public function getSee($company)
{
    ...
    if (!Storage::disk('public')->exists($company['cert_path'])) {
    ...
    $see->setService($company['production'] ? "" : SunatEndpoints::FE_BETA);
    ...
    public function getCompany($company)
    {
        return (new Company())
            ...
            ->setRazonSocial($company['razonSocial'] ?? null ?? null)
            ->setNombreComercial($company['nombreComercial'] ?? null ?? null)
    ...
    public function getDetails($details)
    {
        ...
        foreach ($details as $detail) {
            $invoice_details[] = (new SaleDetail())
